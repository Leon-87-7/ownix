...
- adding a new page with skills for utilizing the transcripts and other output md files
...
there is currently _no_ visible sort control at all — only the page-size select.
