...
import { NewsletterCandidateRow } from './newsletter-candidate-row';
...
describe('NewsletterCandidateRow', () => {
  it('renders the candidate URL separately from the create-job action', () => {
    const onPromote = vi.fn();
    render(<NewsletterCandidateRow candidate={candidate} onPromote={onPromote} />);
  ...
  it('calls dismiss only for pending candidates', () => {
    ...
    render(<NewsletterCandidateRow candidate={candidate} onDismiss={onDismiss} />);
