...
export function InstagramIcon(props: React.SVGProps<SVGSVGElement>) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={grad('yellow-orange-pink')}>
          <stop
            offset="0"
            stopColor="#fc0"
          />
        ...
        <linearGradient id={grad('yellow-fade')}>
          <stop
            offset="0"
            stopColor="#fc0"
          />
        ...
        <linearGradient id={grad('purple-fade')}>
          <stop
            offset="0"
            stopColor="#780cff"
          />
        ...
        <linearGradient id={grad('pink-magenta')}>
          <stop
            offset="0"
            stopColor="#ff005f"
          />
