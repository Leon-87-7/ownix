  ...
  return (
    ...
    >
      ...
      <g mask="url(#gemini-icon-mask)">
        <g filter="url(#gemini-icon-filter-b)">
          <ellipse
            cx="163"
            cy="149"
            fill="#3689FF"
        ...
        <g filter="url(#gemini-icon-filter-c)">
          <ellipse
            cx="33.5"
            cy="142.5"
            fill="#F6C013"
        ...
        <g filter="url(#gemini-icon-filter-d)">
          <ellipse
            cx="19.5"
            cy="148.5"
            fill="#F6C013"
