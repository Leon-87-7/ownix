...
// Google "G" mark (lucide-react dropped its brand icons); path is the
// static glyph data, no need for the 23MB simple-icons package for one path.
const GOOGLE_G_PATH =
