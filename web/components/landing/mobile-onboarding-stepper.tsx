 ...
 *
 * Sticking is not this component's concern. The visitor should see the
 * section's heading, its intro paragraph, this stepper, and the wordmark
 * marquee together in one held viewport before it releases — that's a
 * property of the whole intro block, not of the stepper card alone, so the
 * hold lives in `app/page.tsx` (`.onboarding-runway` / `.onboarding-stick` in
 * globals.css) wrapping all four. This component just renders its content in
 * normal flow.
 *
